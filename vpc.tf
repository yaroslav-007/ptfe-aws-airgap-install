...
resource "aws_subnet" "ptfe-vpc-public-subnet" {
  ...
  tags = {
    Name = "Yaro-ptfe-vpc-public-subnet"
  }
}
...
resource "aws_subnet" "ptfe-vpc-private-subnet" {
  ...
  availability_zone       = "eu-west-2a"
  tags = {
    Name = "Yaro-ptfe-vpc-private-subnet"
  }
}
...
resource "aws_internet_gateway" "ptfe-vpc-internet-gw" {
  ...
  tags = {
    Name = "Yaro-ptfe-vpc-internet-gw"
  }
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "Yaro-ptfe-public-route-table"
  }
}
